  ...
  phases: [
    {
      ...
      milestones: [
        { id: "FUND.M1.1", title: "Situation read", actor: "nova-drafts", estimateMinutes: 20, tier: "artifact",
        ...
        { id: "FUND.M1.3", title: "Tier 0 research", actor: "nova-builds", estimateMinutes: h(1), tier: "artifact", sharedId: "SH-06",
        ...
        { id: "FUND.M1.4", title: "Plan v1 generated", actor: "nova-builds", estimateMinutes: h(1), tier: "artifact",
        ...
        { id: "FUND.M1.5", title: "Financial model", actor: "nova-builds", estimateMinutes: h(1), tier: "artifact", sharedId: "SH-04",
          description: "Driver-based. You adjust drivers; Nova handles the math." },
        { id: "FUND.M1.6", title: "Read the score", actor: "nova-drafts", estimateMinutes: 15, tier: "artifact",
        ...
        { id: "FUND.M1.7", title: "Positioning statement", actor: "nova-drafts", estimateMinutes: 10, tier: "artifact", sharedId: "SH-01",
          description: "The one line the deck, the page and every conversation open with. Carried across from Ship if it exists there; otherwise Nova drafts three from the situation read and you pick." },
      ],
    },
    {
      id: "week-2", title: "Week 2 — Evidence and materials",
      milestones: [
        { id: "FUND.M2.1", title: "Tier 1 outreach pack", actor: "nova-drafts", estimateMinutes: 30, tier: "artifact",
        ...
        { id: "FUND.M2.3", title: "Plan updated with quotes", actor: "nova-builds", estimateMinutes: 0, tier: "artifact",
          description: "Automatic. The score moves. This is the moment the system proves itself." },
        { id: "FUND.M2.4", title: "Assumption risk pass", actor: "nova-drafts", estimateMinutes: 30, tier: "artifact",
        ...
        { id: "FUND.M2.5", title: "Materials", actor: "nova-builds", estimateMinutes: h(2), tier: "artifact",
        ...
        { id: "FUND.M2.6", title: "The five hard questions", actor: "nova-drafts", estimateMinutes: 30, tier: "artifact",
    ...
    },
    {
      ...
      milestones: [
        { id: "FUND.M3.1", title: "Showcase page", actor: "nova-builds", estimateMinutes: 45, tier: "artifact",
        ...
        { id: "FUND.M3.2", title: "Route setup", actor: "nova-builds", estimateMinutes: h(2), tier: "artifact",
        ...
        { id: "FUND.M3.4", title: "Score check before going out", actor: "nova-drafts", estimateMinutes: 15, tier: "artifact",
    ...
    },
    {
      ...
      milestones: [
        ...
        { id: "FUND.M4.2", title: "Response log", actor: "nova-drafts", estimateMinutes: null, tier: "artifact",
          description: "Nova structures your notes after every meeting, call, or rejection." },
        { id: "FUND.M4.3", title: "Objection tracking", actor: "nova-drafts", estimateMinutes: null, tier: "artifact",
          description: "What keeps coming up." },
        { id: "FUND.M4.4", title: "Revise from objections", actor: "nova-builds", estimateMinutes: h(2), tier: "artifact",
          description: "Materials and plan updated. The score recalculates." },
        { id: "FUND.M4.5", title: "Pipeline view", actor: "nova-drafts", estimateMinutes: 30, tier: "artifact",
