  ...
  phases: [
    {
      ...
      milestones: [
        { id: "SYS.M1.1", title: "Time capture", actor: "user-does", estimateMinutes: 10, tier: "claimed",
          description: "Nova prompts once a day and categorizes the response. Deliberately tiny — a full time audit is the kind of homework that ends a path in week one." },
        { id: "SYS.M1.2", title: "Only-me list", actor: "novva-drafts", estimateMinutes: 20, tier: "artifact",
        ...
        { id: "SYS.M1.3", title: "Financial baseline", actor: "novva-drafts", estimateMinutes: 30, tier: "artifact", sharedId: "SH-04",
          description: "Connect an account or upload statements; Nova reads and summarizes. No manual entry." },
        { id: "SYS.M1.4", title: "Bottleneck ranking", actor: "novva-drafts", estimateMinutes: 15, tier: "artifact",
    ...
    },
    {
      ...
      milestones: [
        { id: "SYS.M2.1", title: "Delivery SOP", actor: "novva-drafts", estimateMinutes: h(1), tier: "artifact",
        ...
        { id: "SYS.M2.2", title: "Intake and sales SOP", actor: "novva-drafts", estimateMinutes: h(1), tier: "artifact", description: "How work comes in and how it's sold." },
        { id: "SYS.M2.3", title: "Onboarding SOP", actor: "novva-drafts", estimateMinutes: 45, tier: "artifact",
        ...
        { id: "SYS.M2.4", title: "SOP test", actor: "user-does", estimateMinutes: h(1), tier: "evidence",
          description: "Someone else follows one unaided. Every question they have to ask is a gap." },
        { id: "SYS.M2.5", title: "Close the gaps", actor: "novva-drafts", estimateMinutes: 30, tier: "artifact", description: "From the test." },
      ],
    },
    {
      id: "week-3", title: "Week 3 — Instrument and delegate",
      milestones: [
        { id: "SYS.M3.1", title: "Operating metrics", actor: "novva-drafts", estimateMinutes: 20, tier: "artifact", sharedId: "SH-03",
        ...
        { id: "SYS.M3.2", title: "Where each number comes from", actor: "novva-drafts", estimateMinutes: 20, tier: "artifact",
          description: "Source mapping. Nova pulls what it can automatically." },
        { id: "SYS.M3.3", title: "Dashboard", actor: "novva-builds", estimateMinutes: h(1), tier: "artifact", description: "The metrics, live." },
        { id: "SYS.M3.4", title: "Review cadence", actor: "user-does", estimateMinutes: 5, tier: "claimed",
          description: "A recurring slot that exists in a calendar." },
        { id: "SYS.M3.5", title: "Role definition", actor: "novva-drafts", estimateMinutes: 30, tier: "artifact",
        ...
        { id: "SYS.M3.7", title: "Job post or automation spec", actor: "novva-drafts", estimateMinutes: 30, tier: "artifact", description: "Whichever you chose." },
        { id: "SYS.M3.8", title: "First handoff", actor: "user-does", estimateMinutes: null, tier: "evidence",
          description: "One process, one person, SOP attached." },
      ],
    },
    {
      id: "week-4", title: "Week 4 — Remove the owner",
      milestones: [
        { id: "SYS.M4.1", title: "Automate the top two repetitive tasks", actor: "novva-builds", estimateMinutes: h(3), tier: "artifact",
        ...
        { id: "SYS.M4.2", title: "Runbook for when automation breaks", actor: "novva-drafts", estimateMinutes: 30, tier: "artifact", description: "Because it will." },
        { id: "SYS.M4.3", title: "Pricing review", actor: "novva-drafts", estimateMinutes: 30, tier: "artifact", sharedId: "SH-02",
        ...
        { id: "SYS.M4.4", title: "Absence test", actor: "user-does", estimateMinutes: null, tier: "evidence",
          description: "Three days minimum, shortened from two weeks to fit the month. The three-day version is a first proof, not the finish line; the full test is a follow-on." },
        { id: "SYS.M4.5", title: "Gap list and fixes", actor: "novva-drafts", estimateMinutes: h(1), tier: "artifact", description: "What broke while you were out." },
