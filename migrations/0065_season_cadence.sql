...
ALTER TABLE "sim_seasons" ADD COLUMN "cadence" text DEFAULT 'yearly' NOT NULL;

-- And the seats that buy a faster clock.
ALTER TABLE "companies" ADD COLUMN "sim_quarterly_seats_paid" integer DEFAULT 0 NOT NULL;
ALTER TABLE "companies" ADD COLUMN "sim_monthly_seats_paid" integer DEFAULT 0 NOT NULL;
