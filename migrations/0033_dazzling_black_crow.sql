...
CREATE INDEX "project_milestones_completed_idx" ON "project_milestones" USING btree ("project_id","completed_at");--> statement-breakpoint
CREATE INDEX "user_reputation_last_calculated_idx" ON "user_reputation_scores" USING btree ("last_calculated_at");