...
*   **Project Manager Dashboard:** A 13-tab suite for project management, including:
    ...
    *   **Activity:** Activity Feed and Decision Log.
...
**Routing:** Uses Wouter for client-side routing, managing paths for authentication, onboarding, project management, profiles, community features, Nova AI, Stripe, and contests.
