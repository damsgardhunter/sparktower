 ...
 *
 * Creates the test database and builds the schema by running the migrations.
 * Doing it here rather than per-file means that — comfortably the slowest
 * part — happens a single time however many test files there are.
 *
